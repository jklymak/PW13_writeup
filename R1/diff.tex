...
%DIF ADD ./PW13Paper.tex       Tue May  2 13:03:43 2023
...
%DIFDELCMD <   \includegraphics[width=5in]{LocMapBoth.pdf}
%DIFDELCMD <   %%%
...
48.4\textdegree N and 125.6\textdegree W, with the across-shelf $x$ oriented 39 degrees north of East (}\fref{fig:LocMapBoth}\DIFadd{b, grey/white alternating lines).  The projection is Cartesian with a central latitude at 48.4\textdegree N, which is fine for the limited geographic extents discussed here.
}
